...
Public Class QuoteCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VehicleApplication.QuoteCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedQuoteCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As QuoteCrystalReport = New QuoteCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

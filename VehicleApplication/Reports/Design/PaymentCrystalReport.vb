...
Public Class PaymentCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VehicleApplication.PaymentCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentCrystalReport = New PaymentCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

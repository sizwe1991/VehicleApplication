...
Public Class ProceesedTowing
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        ...
        Else
            ...
            Dim sql As String = "select * from [Towing.] where date between '" & StartDateTimePicker1.Value & "' and '" & EndDateTimePicker2.Value & "'"
            Dim cmd As New SqlDataAdapter
            Dim ds As New DataTable
            Dim report As New ProcessedTowingCrystalReport
